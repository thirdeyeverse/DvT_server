        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4"><a class="btn btn-primary" role="button" data-bss-hover-animate="pulse" href="withdrawreq.php">Back</a>&nbsp; &nbsp; Status Details</h3>
                    <div class="row mb-3">
                        <div class="col-lg-8">
                                    ...
                                    <div class="card shadow" style="padding-bottom: 0;margin-top: 18px;">
                                        ...
                                        <div class="card-body">
                                            <form action="statusedit.php">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="Status"><strong>Status</strong></label><input class="form-control" type="text" id="Status" placeholder=<?php
                                                        include"config.php";
...
$sql = "SELECT * FROM withdrawshop WHERE id=".$_GET['id'];
...
$conn->close();
                                                        ...
                                                        <button class="btn btn-primary d-block btn-user w-100" data-bss-hover-animate="pulse" type="submit">Update Status</button>
                                                    </div>
                                                </div>
                                               </div>
                                                <div class="mb-3"></div>
