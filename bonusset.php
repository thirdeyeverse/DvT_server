            ...
            <div id="content">
              ...
              <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Bonus Coin Settings</p>
                        </div>
                        <div class="container">
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo "<tr>
                                            <td>". $row["Amount"]."</td>
                                            <td>". $row["Extra"]."</td>
                                            <td><a class='btn btn-primary' role='button' data-bss-hover-animate='flash' href='EditBonus.php?id=".$row["id"]."'>Edit</a></td>
                                        </tr>";
  }
} else {
  echo "0 results";
