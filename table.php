        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Players</h3>
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo "<tr>
                                            ...
                                            <td>". $row["userid"]."</td>
                                            <td>". $row["coins"]."</td>
                                            <td><a class='btn btn-primary' role='button' data-bss-hover-animate='flash' href='PlayerDetails.php?id=".$row["id"]."'>Open</a><a class='btn btn-danger btn-circle ms-1' role='button' href='DeletePLayer.php?id=".$row["id"]."' data-bss-hover-animate='bounce'><i class='fas fa-trash text-white'></i></a></td>
